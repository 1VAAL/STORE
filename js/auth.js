...
// (محاط بـ try/catch عشان لو Firebase لسه مش متظبط، باقي الموقع
//  "المتجر، السلة، التصفح" يفضل شغال عادي بدل ما يقف الموقع كله)
// ------------------------------------------------------------------
try {
auth.onAuthStateChanged(async (user) => {
  ...
  console.error('Firebase auth غير مهيأ بعد:', err);
  // نظهر زرار تسجيل الدخول برضو حتى لو Firebase مش شغال
  renderAccountUI();
}
